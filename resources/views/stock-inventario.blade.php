    ...
    <div class="margen-sup">
        ...
        <div class="contenedor">
            ...
            <ul class="nav nav-tabs rounded" style="background-color: lightgray;>
              ...
              <li class="nav-item">
                <a class="nav-link active" href="{{ asset('stock-inventario') }}">Stock de inventario</a>
              </li>
              <li class="nav-item">
                ...
                <div class="col col-sm-6 col-md-6 col-lg-6" style="border:solid;background: white;height: 15em">
                    <form action="" method="post" enctype="multipart/form-data">
                        <div style="position: relative;top:15px">
                            <input type="file" name="stock-inventario" id="archivo_maestro" class="input-large form-control">
